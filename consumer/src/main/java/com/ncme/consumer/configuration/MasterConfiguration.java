...
package com.ncme.consumer.configuration;
...
@MapperScan(basePackages = "com.ncme..**.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
public class MasterConfiguration {
	
	   @Autowired 
	    private com.ncme.consumer.configuration.properties.DruidProperties druidProperties; 	
