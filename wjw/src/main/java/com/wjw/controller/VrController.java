...
public class VrController extends Controller{
	...
	/**
	 * 
	 * getVrCvList:(这里用一句话描述这个方法的作用)
	 * TODO(获取VR/三维动画列表(标签为VR/三维动画的课程)
	 *
	...
	public RtnBody getVrCvList(String accountName, String userId, String xueke, String hot, String pageNum){
	...
	public RtnBody getVrCvDetail(String userId, String typicalId){
		SystemUser user = SystemUserUtil.getLoginUser(request);
		RtnBody rtn = new RtnBody();
	...
	/**
	 * 
	 * getVrCvCatalog:(这里用一句话描述这个方法的作用)
	 * TODO(获取VR/三维动画目录)
	 *
	 * @param  @param userId
	 * @param  @param typicalId
	...
	public RtnBody getVrCvCatalog(String userId, String typicalId){
		SystemUser user = SystemUserUtil.getLoginUser(request);
		RtnBody rtn = new RtnBody();
		Map<String,Object> map=new HashMap<String, Object>();
